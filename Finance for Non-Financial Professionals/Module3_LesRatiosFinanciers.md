...
\[ \text{Ratio de Liquidité Courante} = \frac{\text{Actifs Courants}}{\text{Passifs Courants}} \]
...
\[ \text{Ratio de Liquidité Courante} = \frac{50\,000}{25\,000} = 2 \]
...
\[ \text{Quick Ratio} = \frac{\text{Actifs Courants} - \text{Stocks}}{\text{Passifs Courants}} \]
...
\[ \text{Quick Ratio} = \frac{50\,000 - 10\,000}{25\,000} = 1.6 \]
...
\[ \text{Ratio de Rotation des Actifs} = \frac{\text{Chiffre d'Affaires}}{\text{Actifs Totaux}} \]

**Exemple :** Si une entreprise a un chiffre d'affaires de 200 000 $ et des actifs totaux de 100 000 $ :

\[ \text{Ratio de Rotation des Actifs} = \frac{200\,000}{100\,000} = 2 \]
...
\[ \text{Marge Bénéficiaire Nette} = \frac{\text{Bénéfice Net}}{\text{Chiffre d'Affaires}} \times 100 \]

**Exemple :** Si une entreprise a un bénéfice net de 40 000 $ et un chiffre d'affaires de 200 000 $ :

\[ \text{Marge Bénéficiaire Nette} = \frac{40\,000}{200\,000} \times 100 = 20\% \]
...
\[ \text{Ratio d'Endettement} = \frac{\text{Passifs Totaux}}{\text{Actifs Totaux}} \]

**Exemple :** Si une entreprise a des passifs totaux de 50 000 $ et des actifs totaux de 100 000 $ :

\[ \text{Ratio d'Endettement} = \frac{50\,000}{100\,000} = 0.5 \]
...
\[ \text{ROE} = \text{Marge Nette} \times \text{Rotation des Actifs} \times \text{Levier Financier} \]

**Exemple :** Si une entreprise a une marge nette de 10 %, une rotation des actifs de 1,5, et un levier financier de 2 :

\[ \text{ROE} = 0.10 \times 1.5 \times 2 = 0.30 \text{ ou } 30\% \]
...
| Bénéfice Net ($) | Bénéfices Retenus ($) | Dividendes ($)

 | Pourcentage de Dividende (%) |
|------------------|-----------------------|----------------|------------------------------|
| 50 000           | 30 000                | 20 000         | 40                           |
| 100 000          | 60 000                | 40 000         | 40                           |
| 150 000          | 90 000                | 60 000         | 40                           |

### 3.4.3 Rendement des Dividendes

Le rendement des dividendes mesure le retour sur investissement pour les actionnaires sous forme de dividendes par rapport au prix de l'action.

\[ \text{Rendement des Dividendes} = \frac{\text{Dividende par Action}}{\text{Prix de l'Action}} \times 100 \]

**Exemple :** Si une entreprise verse un dividende de 2 $ par action et que le prix de l'action est de 40 $ :

\[ \text{Rendement des Dividendes} = \frac{2}{40} \times 100 = 5\% \]

**Tableau 9 : Rendement des Dividendes**

| Dividende par Action ($) | Prix de l'Action ($) | Rendement des Dividendes (%) |
|--------------------------|----------------------|------------------------------|
| 2                        | 40                   | 5                            |
| 3                        | 50                   | 6                            |
| 4                        | 60                   | 6.67                         |
...
Ce module a présenté les ratios financiers essentiels, incluant les ratios de liquidité, les ratios d'actif, de rentabilité et d'endettement, la pyramide de DuPont, ainsi que les bénéfices et les dividendes. La compréhension et l'utilisation de ces ratios permettent aux gestionnaires de mieux évaluer la santé financière d'une entreprise, d'identifier les domaines nécessitant des améliorations et de prendre des décisions éclairées pour assurer la rentabilité et la croissance à long terme de l'entreprise.
